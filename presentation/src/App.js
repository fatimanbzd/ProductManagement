    ...
    <Layout>   
      <Routes>
        ...
        <Route path='/edit-product/:id' element={<UpdateProduct></UpdateProduct>}></Route>
         <Route path='/customers' element={<AllCustomer> </AllCustomer>}></Route>
         <Route path='/add-customer' element={<AddCustomer></AddCustomer>}></Route>
         <Route path='/edit-customer/:id' element={<UpdateCustomer></UpdateCustomer>}></Route> 
          <Route path='/add-customerOrder' element={<AddCustomerOrder></AddCustomerOrder>}></Route>
      </Routes>
  </Layout>
